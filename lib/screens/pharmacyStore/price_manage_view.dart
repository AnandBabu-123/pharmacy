                            ...
                            Column(
                              children: [
                                Row(
                                  children: [
                                    Expanded(
                                      child: Text("Store ID: ${item.data.storeId ?? "-"}"),
                                    ),
                                    Expanded(
                                      child: Text("Manufacturer: ${item.data.manufacturer ?? "-"}"),
                                    ),
                                  ],
                                ),
                                ...
                                Row(
                                  children: [
                                    Expanded(
                                      child: Text("Item Code: ${item.data.itemCode ?? "-"}"),
                                    ),
                                    Expanded(
                                      child: Text("Item Name: ${item.data.itemName ?? "-"}"),
                                    ),
                                  ],
                                ),
                                const SizedBox(height: 4),
                                ...
                                Row(
                                  children: [
                                    Expanded(
                                      child: Text("Expiry Date: ${formatDate(item.data.expiryDate)}"),
                                    ),
                                    Expanded(
                                      child: Text("Balance Qty: ${item.data.balQuantity ?? "-"}"),
                                    ),
                                  ],
                                ),
                                const SizedBox(height: 4),
                                ...
                                Row(
                                  children: [
                                    Expanded(
                                      child: Text("Bal Pack Quantity: ${item.data.balPackQuantity ?? "-"}"),
                                    ),
                                    Expanded(
                                      child: Text("Bal Loose Quantity: ${item.data.balLooseQuantity ?? "-"}"),
                                    ),
                                  ],
                                ),
                                const SizedBox(height: 4),
                                ...
                                Row(
                                  children: [
                                    Expanded(
                                      child: Text("MRP Pack: ${item.data.mrpPack ?? "-"}"),
                                    ),
                                    Expanded(
                                      child: Text("MRP Value: ${item.data.mrpValue ?? "-"}"),
                                    ),
                                  ],
                                ),
                                const SizedBox(height: 4),
                                ...
                                Row(
                                  children: [
                                    Expanded(
                                      child: Text("Rack: ${item.data.rack ?? "-"}"),
                                    ),
                                    Expanded(
                                      child: Text("Online (Y/N): ${item.data.onlineYesNo ?? "-"}"),
                                    ),
                                  ],
                                ),
                                const SizedBox(height: 4),
                                ...
                                Row(
                                  children: [
                                    Expanded(
                                      child: Text("Updated At: ${formatDate(item.data.updatedAt)}"),
                                    ),
                                    Expanded(
                                      child: Text("Updated By: ${item.data.updatedBy ?? "-"}"),
                                    ),
                                  ],
                                ),
                              ],
